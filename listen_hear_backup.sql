...
--
-- Name: products_csvimport; Type: TABLE; Schema: public; Owner: debug
--

CREATE TABLE public.products_csvimport (
    id bigint NOT NULL,
    csv_file character varying(100) NOT NULL,
    uploaded_at timestamp with time zone NOT NULL,
    packages_created integer NOT NULL,
    packages_updated integer NOT NULL,
    packages_skipped integer NOT NULL,
    error_log text NOT NULL,
    uploaded_by_id bigint,
    property_types_detected character varying(500) NOT NULL
);


ALTER TABLE public.products_csvimport OWNER TO debug;

--
-- Name: products_csvimport_id_seq; Type: SEQUENCE; Schema: public; Owner: debug
--

ALTER TABLE public.products_csvimport ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.products_csvimport_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
1	gallery/hero_navbar.png			2026-01-13 00:27:21.54326+00	2026-01-13 00:27:21.543279+00	0
2	gallery/close-up-of-nautical-rope-with-knot-and-ocean-background-free-photo.jpg			2026-01-13 00:28:09.272906+00	2026-01-13 00:28:09.27293+00	0
3	gallery/Wedding_The_Dip_Kiss_Dramatic_2025-10-31_ouim.png			2026-01-13 00:38:47.710348+00	2026-01-13 00:38:47.710386+00	0
4	gallery/shopping.webp			2026-01-13 00:49:49.877344+00	2026-01-13 00:49:49.877374+00	0
5	gallery/Rainy-Boston-Public-Garden-Hawaiian-Indian-Wedding-024.jpg			2026-01-13 00:53:31.957932+00	2026-01-13 00:53:31.957996+00	0
6	gallery/weddings-2013-06-4-rubin-singer-wedding-dresses-wedding-gowns-beyonce-0605-main.webp			2026-01-13 00:53:55.335433+00	2026-01-13 00:53:55.335466+00	0
7	gallery/aurela-redenica-Rp7R5JvkR4M-unsplash.jpg			2026-01-13 00:54:51.899341+00	2026-01-13 00:54:51.899372+00	0
8	gallery/Gemini_Generated_Image_u9hk92u9hk92u9hk.png			2026-01-14 23:49:20.316119+00	2026-01-14 23:49:20.316136+00	0
\.
...
--
-- Data for Name: products_csvimport; Type: TABLE DATA; Schema: public; Owner: debug
--

COPY public.products_csvimport (id, csv_file, uploaded_at, packages_created, packages_updated, packages_skipped, error_log, uploaded_by_id, property_types_detected) FROM stdin;
1	csv_imports/smart_home_products_rewritten.csv	2025-12-07 20:32:14.148063+00	66	0	0		1	
2	csv_imports/smart_home_products_rewritten_RsFKvUx.csv	2025-12-07 20:50:44.929653+00	0	0	66		1	Residential (45), Commercial (6), Industrial (15)
3	csv_imports/smart_home_products_rewritten_VRlDuAM.csv	2025-12-07 20:56:45.689525+00	66	0	0		1	Residential (45), Commercial (6), Industrial (15)
\.
...
2	\N	2025-12-08 19:16:36.502041+00	2025-12-08 19:16:36.502062+00	1	\N
...
--
-- Name: products_csvimport_id_seq; Type: SEQUENCE SET; Schema: public; Owner: debug
--

SELECT pg_catalog.setval('public.products_csvimport_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.quotes_quoterequest_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.quotes_quoterequestitem_id_seq', 22, true);
...
--
-- Name: products_csvimport products_csvimport_pkey; Type: CONSTRAINT; Schema: public; Owner: debug
--

ALTER TABLE ONLY public.products_csvimport
    ADD CONSTRAINT products_csvimport_pkey PRIMARY KEY (id);
...
--
-- Name: products_csvimport_uploaded_by_id_bd55a073; Type: INDEX; Schema: public; Owner: debug
--

CREATE INDEX products_csvimport_uploaded_by_id_bd55a073 ON public.products_csvimport USING btree (uploaded_by_id);
...
--
-- Name: products_csvimport products_csvimport_uploaded_by_id_bd55a073_fk_users_user_id; Type: FK CONSTRAINT; Schema: public; Owner: debug
--

ALTER TABLE ONLY public.products_csvimport
    ADD CONSTRAINT products_csvimport_uploaded_by_id_bd55a073_fk_users_user_id FOREIGN KEY (uploaded_by_id) REFERENCES public.users_user(id) DEFERRABLE INITIALLY DEFERRED;
