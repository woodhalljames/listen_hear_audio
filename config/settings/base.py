...
# listen_hear_audio/
APPS_DIR = BASE_DIR / "listen_hear_audio"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "listen_hear_audio.contrib.sites.migrations"}
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "listen_hear_audio.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "listen_hear_audio.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "listen_hear_audio.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
