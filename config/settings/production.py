...
AWS_S3_ENDPOINT_URL = env("CLOUDFLARE_R2_ENDPOINT_URL")  # https://<account-id>.r2.cloudflarestorage.com
AWS_S3_CUSTOM_DOMAIN = env("CLOUDFLARE_R2_CUSTOM_DOMAIN")  # e.g. media.listenhearsmarthomes.com or pub-xxx.r2.dev
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Listen Hear! <info@listenhearsmarthomes.com>",
)
